...
public class Proyecto extends javax.swing.JFrame {
    ...
    // Método para obtener los términos del producto utilizado en las ecuaciones de
    // cada punto
        ...
        try {
            ...
            for (int i = 0; i < n; i++) {
                ...
                for (int j = i + 1; j < n; j++) {
                    ...
                    if (Math.abs(matrix[j][i]) > Math.abs(matrix[max][i])) { // Math.abs devuelve el valor absoluto de
                                                                             // un numero
                        max = j;
                    }
                }
                // verifica si el valor absoluto de la entrada actual es mayor que el valor
                // absoluto
                // de la entrada máxima encontrada hasta ese momento en la misma columna
                // si cambio max, entonces significa que la condicion se cumplio y hay que
                // intercambiar
                if (max != i) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                resultado += "a" + i + " * " + punto_obtenido + "^" + i + " = " + ai + " * " + xi + " = "
            ...
            for (int i = 0; i < n; i++) {
                double ai = matrix[i][n]; // Obtiene el valor de ai de la última columna de la fila i
                double multiplicacion = ai * Math.pow(punto_obtenido, i); // Calcula el resultado de ai por
                                                                          // punto_obtenido elevado a la potencia i
                if (i == 0) {
                    ...
                    if (multiplicacion >= 0) {
                        ...
                        multiplicacion = Math.abs(multiplicacion); // Obtenemos el valor absoluto del resultado para
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGap(46, 46, 46)
                                                .addComponent(jButtonlimpiar, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                ...
                                                                .addComponent(text_field_num_puntos,
                                                ...
                                                .addComponent(punto, javax.swing.GroupLayout.PREFERRED_SIZE, 157,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jButtonsistema, javax.swing.GroupLayout.PREFERRED_SIZE,
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(text_field_num_puntos, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 31,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(punto, javax.swing.GroupLayout.PREFERRED_SIZE, 43,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jButtonsistema, javax.swing.GroupLayout.PREFERRED_SIZE, 30,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jButton_generar_polinomio)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton_generar_polinomioActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton_generar_polinomioActionPerformed
        ...
        try {
            ...
            for (i = 0; i < numero_puntos; i++) {
                try {
                    String valorStringX = JOptionPane.showInputDialog(null,
                            "Ingrese la coordenada X del punto " + (i + 1));
                    double valorX = Double.parseDouble(valorStringX);
                    String valorStringY = JOptionPane.showInputDialog(null,
                            "Ingrese la coordenada Y del punto " + (i + 1));
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Ha ingresado un valor no válido. Por favor, inténtelo de nuevo.");
                    i--;
                }
            }
            Object col[] = new Object[numero_puntos + 1]; // el arreglo mostrara las matriz aumentada y la matriz de
                                                          // resultados.
            ...
            modelo = new DefaultTableModel(col, numero_puntos); // se dimensiona la matriz aumentada en la tablita y se
                                                                // hace llamada
            // a la clase con dos parametros.

            matriz.setModel(modelo); // matriz hace referencia al jtable, se modifica segun las dimensiones del
                                     // modelo.

            for (i = 0; i < numero_puntos; i++) {
                modelo.setValueAt(1, i, 0); // inicializa la primera columna con 1 en la fila i
                modelo.setValueAt(puntos[i][0], i, 1);
                ...
                // Agregar la columna de "y" de la tabla jTable1 a la columna correspondiente en
                // la tabla matriz
        ...
        try {
            ...
            for (int i = 0; i < n; i++) {
                for (int j = 0; j < n; j++) {
                    ...
                    m[i][j] = Double.parseDouble(String.valueOf(matriz.getValueAt(i, j))); // convertir a decimal los
                                                                                           // campos string
                }
                r[i] = Double.parseDouble(String.valueOf(matriz.getValueAt(i, n)));
            }
            /*
             * En este codigo hacemos las operaciones para tener la matriz aumentada,
             * concatenando
             * m y r
             */
